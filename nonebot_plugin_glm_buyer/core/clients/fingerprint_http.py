...
from nonebot_plugin_glm_buyer.core.browser_profiles import (
...
class FingerprintHttpClient:
    ...
    def _resolve_profile(self, browser_impersonate: str | None) -> BrowserProfile:
        ...
        profile_id = resolve_browser_impersonate(browser_impersonate or self.settings.browser_impersonate)
